 ...
 */
package mx.itson.identificador.negocio;
...
public class Metodos {
   //Indica los valores asignados a la variable
   ...
   String curpg= "";
    ...
    //Apartir de aquí es para que el botón de guardar almacene los datos de esta clase.
    //Indica el metodo del comboBox.
    public void getEstado(String boxEstado){
        estado = boxEstado;
        
    }
   //Indica el metodo de despliegue del comboBox
    public void getSexo(String boxsexo){
        sexo = boxsexo;
    }
    //Indica los valores enteros de dia, mes, año y el metodo a seguir.
  ...
  //Indica el metodo de la obtención de nombres para capturar datos en el interfaz.  
        public void getNombre (String a, String b, String c){
        nombre = a.toUpperCase(); // toUpperCase se convierte en mayusculas
     ...
     if(mes < 10){
       ...
       c8 = month.charAt(0);
         ...
         curpg = String.valueOf(c1+""+c2+""+c3+""+c4+""+c5+""+c6+""+c7+""+c8+""+c9+""+c10+""+c11+""+c12+""+c13+""+c14+""+c15+""+c16+""+c17+""+c18);
          JOptionPane.showMessageDialog(null,curpg); //Refleja en pantalla la curp.
